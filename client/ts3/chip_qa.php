	...
	<body style="min-width:100%;">
		...
		<script>
			...
			function getAndDrawChips(){
				...
				var url = 'http://timesync.forestry.oregonstate.edu/_ts3/data/'+initialDrawInfo.userID+'/'+initialDrawInfo.projectID+'/'+initialDrawInfo.tsa+'/'+initialDrawInfo.plotID+'/'+year //dataFromOrigin.year						
			...
			$(window).on("message onmessage",function(e){
				...
				switch(dataFromOrigin.action){
					case "add_chips":
						...
						$.getJSON('http://timesync.forestry.oregonstate.edu/_ts3/data/'+initialDrawInfo.userID+'/'+initialDrawInfo.projectID+'/'+initialDrawInfo.tsa+'/'+initialDrawInfo.plotID).done(function(returnedData){
