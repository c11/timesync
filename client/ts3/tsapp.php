<?php
	require '../_y/vendor/autoload.php';
	require_once '../_y/config.php';
...
<!-- 			<div id="commentsSection" class="sectionDiv">
		...
		<div id="chipGallerySection">
			<p class="header">Image Chip Gallery</p> <!--<span id="expandChipGallery" class="glyphicon glyphicon-new-window right-align" style="float:right; margin:3px; cursor:pointer"></span>-->
