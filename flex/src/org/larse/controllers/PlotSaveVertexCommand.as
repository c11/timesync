package org.larse.controllers
{
	...
	public class PlotSaveVertexCommand
	{
		...
		{
			trace("PlotSaveVertexCommand.result()");
		...
		public function error(fault:FaultEvent):void
		{
			...
			Alert.show("Database had an error", "Save Vertex Error");
		}
	}
}