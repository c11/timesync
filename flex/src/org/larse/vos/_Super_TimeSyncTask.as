 ...
 * of this value object you may modify the generated sub-class of this class - TimeSyncTask.as.
 */
...
[ExcludeClass]
public class _Super_TimeSyncTask extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _TimeSyncTaskEntityMetadata;
    ...
    public function _Super_TimeSyncTask()
    {
        _model = new _TimeSyncTaskEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _TimeSyncTaskEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _TimeSyncTaskEntityMetadata) : void
    {
        var oldValue : _TimeSyncTaskEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
