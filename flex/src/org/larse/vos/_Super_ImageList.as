 ...
 * of this value object you may modify the generated sub-class of this class - ImageList.as.
 */
...
[ExcludeClass]
public class _Super_ImageList extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _ImageListEntityMetadata;
    ...
    private var _internal_julday : int;
    ...
    public function _Super_ImageList()
    {
        _model = new _ImageListEntityMetadata(this);
    ...
    {
        var oldValue:int = _internal_julday;
        if (oldValue !== value)
        {
            _internal_julday = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "julday", oldValue, _internal_julday));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ImageListEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ImageListEntityMetadata) : void
    {
        var oldValue : _ImageListEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
